...
public class ExtractedInfo {
    ...
    // New fields for models used in the paper
    private List<String> modelsUsedInPaper;
    private List<String> algorithmsUsedInPaper;
    private List<String> frameworksUsedInPaper;
    private List<String> librariesUsedInPaper;
    ...
    // New getters and setters for models used in paper
    public List<String> getModelsUsedInPaper() { return modelsUsedInPaper; }
    public void setModelsUsedInPaper(List<String> modelsUsedInPaper) { this.modelsUsedInPaper = modelsUsedInPaper; }

    public List<String> getAlgorithmsUsedInPaper() { return algorithmsUsedInPaper; }
    public void setAlgorithmsUsedInPaper(List<String> algorithmsUsedInPaper) { this.algorithmsUsedInPaper = algorithmsUsedInPaper; }

    public List<String> getFrameworksUsedInPaper() { return frameworksUsedInPaper; }
    public void setFrameworksUsedInPaper(List<String> frameworksUsedInPaper) { this.frameworksUsedInPaper = frameworksUsedInPaper; }

    public List<String> getLibrariesUsedInPaper() { return librariesUsedInPaper; }
    public void setLibrariesUsedInPaper(List<String> librariesUsedInPaper) { this.librariesUsedInPaper = librariesUsedInPaper; }
    ...
    public ExtractedInfo() {
        ...
        this.modelsUsedInPaper = new ArrayList<>();
        this.algorithmsUsedInPaper = new ArrayList<>();
        this.frameworksUsedInPaper = new ArrayList<>();
        this.librariesUsedInPaper = new ArrayList<>();
    }
}